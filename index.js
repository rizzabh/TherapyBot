...
const sad = ["bt", "sad", "depressed", "unhappy", "anxiety", "kms", "Sad", "Bt", "Depressed", "Anxiety", "Unhappy", "Kms", "hate", "Hate", "hates","Suicide","suicide"]
...
client.on("message", msg => {
  ...
  if (msg.content.startsWith("!commands")) {
    msg.channel.send(
      ` \`!sed\` : Random quote generated by zenquote api
    
    \`cats/cat\` : Generates a random cat image.
    
    \`!meme\` : Generates a random meme from r/memes.

    \`bt\`, \`sad\`, \`depressed\`, \`unhappy\`,\`anxiety\` : randomly generates quotes 
     added in the list
