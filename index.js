...
const sad = ["bt", "sad", "depressed", "unhappy", "anxiety"]
const phrase = ["There exists no bad trip in the land of traveler", "Come on you got it ", "The only way from rock bottom is Up ~Harsh Maru", "Thug it out", "Its fine not everyday are UPS"]
